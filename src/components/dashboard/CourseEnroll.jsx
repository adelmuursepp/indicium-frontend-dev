...
import { sendEnrollmentDetails } from "../../utils/dashboard";
...
const CourseEnroll = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const error = await sendEnrollmentDetails({
      courseName,
      term,
      year,
    });
          ...
          <Box my={4} textAlign="left">
            <form onSubmit={handleSubmit}>
              ...
              <FormControl isRequired>
                <FormLabel>Enter CourseID</FormLabel>
                <Input
                  type="input"
                  placeholder="CSC209"
